...
\[
	...
	+ \imath_{[0,\bar{m}]}(\mu).
\]
\Cref{fig:CrowdExamplePotential} shows an example potential where we use the Euclidean distance to the target $\mathscr{A}$.
...
\begin{figure}
	\centering
	\begin{subfigure}[c]{.4\linewidth}
		\includegraphics[width=\linewidth]{../project/images/multimarg_room3/congestion_plot.pdf}\caption{Congestion plot for the third room.}
	\end{subfigure}~
	\begin{subfigure}[c]{.4\linewidth}
